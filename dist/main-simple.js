...
exports.SimpleTestingAgent = void 0;
...
class SimpleTestingAgent {
    ...
    setupMiddleware() {
        ...
        this.app.use(express_1.default.static(path_1.default.join(__dirname, '../web/dashboard')));
    }
    setupRoutes() {
        // Health check
...
exports.SimpleTestingAgent = SimpleTestingAgent;
// CLI functionality
async function main() {
