...
const mockReviews: Review[] = [
  {
    ...
    name: 'Aisha K.',
    avatarText: 'AK',
    reviewText: "GoCars got me from Lindley to the station right on time! The car was spotless and the driver was so polite. Excellent service!",
    stars: 5,
  ...
  },
  {
    ...
    name: 'Tom P.',
    avatarText: 'TP',
    reviewText: "Fantastic trip to Holmfirth with GoCars. The driver knew all the shortcuts and the app made booking super easy. Will use again!",
    stars: 5,
    location: "Holmfirth",
  },
  {
  ...
  },
  {
    ...
    name: 'David R.',
    avatarText: 'DR',
    reviewText: "Needed a quick ride from Almondbury and GoCars delivered. The driver was helpful with my shopping. Five stars!",
    stars: 5,
  ...
  },
  {
    ...
    name: 'Chloe G.',
    avatarText: 'CG',
    reviewText: "Consistent and dependable. I use GoCars regularly for trips around Huddersfield. Always a pleasant experience.",
    stars: 5,
