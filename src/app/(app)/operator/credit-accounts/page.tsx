                ...
                <Form {...addAccountForm}>
                  <form onSubmit={addAccountForm.handleSubmit(onAddAccountSubmit)} className="space-y-4 py-2">
                    ...
                    <FormField control={addAccountForm.control} name="associatedUserId" render={({ field }) => (
                        <FormItem><FormLabel>Associated Passenger User ID <span className="text-red-500">*</span></FormLabel><FormControl><Input placeholder="User's GoCars ID" {...field} required /></FormControl><FormMessage /></FormItem>
                    )} />
            ...
            {editAccount && (
              <Form {...addAccountForm}>
                ...
                >
                  ...
                  <FormField control={addAccountForm.control} name="associatedUserId" render={({ field }) => (
                    <FormItem><FormLabel>Associated Passenger User ID <span className="text-red-500">*</span></FormLabel><FormControl><Input placeholder="User's GoCars ID" {...field} defaultValue={editAccount.associatedUserId} required /></FormControl><FormMessage /></FormItem>
                  )} />
                  <FormField control={addAccountForm.control} name="creditLimit" render={({ field }) => (
